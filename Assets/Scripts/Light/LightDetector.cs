...
{
    //SCRIPT WAS TAKEN FROM https://www.youtube.com/watch?v=2PQ12DZ37i8&ab_channel=Artusad
    ...
    private void Start()
    {
        if (m_camLightScan == null)
            m_camLightScan = Camera.main;
        StartLightDetection();
    }
